import { addClass, removeClass } from "helpers/formating/classNameModifier";
...
export default function Carousel({ children, refContainer }) {
  ...
  const allowToShift = useRef(true);
  ...
  const onClick = useCallback((e) => {
    e = e || window.event;
    !allowToShift.current && e.preventDefault();
  }, []);
