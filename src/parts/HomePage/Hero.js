    ...
    <section className="flex items-center hero">
      <div className="w-full absolute z-20 inset-0 md:relative md:w-1/2 text-center flex flex-col justify-center hero-caption ">
        ...
        <h2 className="px-8 text-base md:px-0 md:text-lg my-6 tracking-wide">
          we provide furniture hight quality
          <br className="hidden lg:block" />
          thats make your room comfortable
        </h2>
        <div>
          <a
        ...
        <div className="relative hero-image">
          ...
          <div className="overlay right-0 bottom-0 md:inset-0">
            <button
              ...
              data-content='
              <div class="w-screen pb-56 md:w-80 md:pb-56 relative z-50">
                <div class="absolute w-full h-full">
                  <iframe
                    width="100%"
                    height="100%"
                    src="https://www.youtube.com/embed/rRcY6rdsCEI?start=1"
          ...
          <img
            ...
            alt="House With Sofa and Some Plant"
          />
        </div>
      </div>
    </section>
