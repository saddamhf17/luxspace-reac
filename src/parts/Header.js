        ...
        <div className="container mx-auto xl:px-1 py-10">
          <div className="flex flex-stretch items-center">
            <div className="w-56 flex items-center"> 
                <img src="assets/img/logo.png" alt="Luxspace - Adalah website yang menjual perlengkapan rumah"/>
            </div>
            <div className="w-full"></div>
            <div className="w-auto">
              <ul id="menu" className="fixed bg-white inset-0 flex flex-col invisible items-center 
              justify-center opacity-0 md:visible md:flex-row md:bg-transparent md:relative md:opacity-100 ">
               
                <li className="mx-3 py-6 md:py-0">
                <Link to='/showcase' className="text-black hover:text-white hover:underline">
                Showcase
                </Link>
                </li>
                <li className="mx-3 py-6 md:py-0">
                <Link to='/catalog' className="text-black hover:text-white hover:underline">
                Catalog
                </Link>
                </li>
                <li className="mx-3 py-6 md:py-0">
                <Link to='/delivery' className="text-black hover:text-white hover:underline">
                Delivery
                </Link>
                </li>
                <li className="mx-3 py-6 md:py-0">
                <Link to='/rewards' className="text-black hover:text-white hover:underline">
                Rewards
                </Link>
                </li>
              </ul>
            ...
            <div className="w-auto">
              <div className="flex items-center">
                <li className="ml-6 block md:hidden">
                  <button id="menu-toggler" className="relative flex z-50 items-center justify-center w-8 h8 text-black hover:text-white  focus:outline-none">
                ...
                <li className="ml-6 block">
                  <Link to='/cart' className="flex justify-center items-center w-8 h-8 text-black hover:text-white cart cart-filled">
                    <svg className="fill-current" width="29" height="25" viewBox="0 0 29 25" fill="none" xmlns="http://www.w3.org/2000/svg">
